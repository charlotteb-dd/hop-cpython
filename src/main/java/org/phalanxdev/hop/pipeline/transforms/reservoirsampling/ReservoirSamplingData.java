...
/**
 * Holds temporary data (i.e. sampled rows). Implements the reservoir sampling
 * algorithm "R" by Jeffrey Scott Vitter.
 * <p>
 * For more information see:<br>
 * <br>
 * <p>
 * Vitter, J. S. Random Sampling with a Reservoir. ACM Transactions on
 * Mathematical Software, Vol. 11, No. 1, March 1985. Pages 37-57.
 *
...
public class ReservoirSamplingData extends BaseTransformData implements ITransformData {
	...
	/**
	 * Determine the current operational state of the Reservoir Sampling transform.
	 * Sampling, PassThrough(Do not wait until end, pass through on the fly),
	 * Disabled.
	 *
	 ...
	 *
	 * @param state member of PROC_MODE enumeration indicating the desired
	 *              operational state
	 */
	...
	/**
	 * Here is where the action happens. Sampling is done using the "R" algorithm of
